...
{
    public abstract class HelloGitlabWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HelloGitlabWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HelloGitlabWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HelloGitlabDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HelloGitlabDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HelloGitlabDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HelloGitlabDbContext, Task<T>> func)
        {
            T result;
